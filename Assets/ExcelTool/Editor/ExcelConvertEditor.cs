...
{
    public class ExcelConvertEditor : EditorTestWindow
    {
        ...
        {
            excelEditorWIn = EditorTestWindow.GetWindow<ExcelConvertEditor>();
        ...
        void Awake()
        {
            ...
            cSharpPath = Application.dataPath + "/GameData/Data/GameDataCScripts";
